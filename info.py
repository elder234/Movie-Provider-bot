...
API_ID = int(environ.get('API_ID', '15364953'))
API_HASH = environ.get('API_HASH', '82f0fb9b6b4176c593648ad4a18479f9')
BOT_TOKEN = environ.get('BOT_TOKEN', "6810139632:AAF--RWKE5BNkB_uZYGtBNCvQ_-fccVpOEk")
...
STREAM_API = (environ.get('STREAM_API', '4469791c069c42025fbc5a0e1'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/Ultroid_Official/18'))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1757990244').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002088199503') # request channel id ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nile:1234@cluster0.dwchtg7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '4469791c069c42025fbc5a0e1')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))  # else--> True
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+U5lfwZWLY1ZiNDU0')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+BdXh4y_MFqBhZTA0')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002088199503')) #Log channel id ( make sure bot is admin )
